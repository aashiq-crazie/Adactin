...
import com.adactin.helper.TestData;

public class BookItenaryPage extends TestData {
...
//	}
	...
	// @FindBy(xpath =
	// "//input[@value='Aashiq']//parent::td//preceding-sibling::td[4]")
	...
	public WebElement getRadioButton() {
		WebElement radioButton = driver
				.findElement(By.xpath("//input[@value='" + fName + "']//parent::td//preceding-sibling::td[4]"));
		return radioButton;
	}
}
